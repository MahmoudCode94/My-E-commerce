    ...
    <div className="flex items-center justify-center min-h-screen p-6 bg-slate-50 dark:bg-slate-950">
      <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-[2rem] shadow-xl p-8 border border-slate-100 dark:border-slate-800">
        <div className="flex flex-col items-center mb-6">
          <h1 className="text-2xl font-black text-slate-900 dark:text-slate-50">Change Password</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Secure your account with a new password</p>
        </div>
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className={`w-full px-4 py-3 text-sm border rounded-xl outline-none bg-slate-50 dark:bg-slate-800 dark:text-white transition-all ${formik.touched.currentPassword && formik.errors.currentPassword ? 'border-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-emerald-500'}`}
            />
          ...
          <div>
            <input
              ...
              className={`w-full px-4 py-3 text-sm border rounded-xl outline-none bg-slate-50 dark:bg-slate-800 dark:text-white transition-all ${formik.touched.password && formik.errors.password ? 'border-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-emerald-500'}`}
            />
          ...
          <div>
            <input
              ...
              className={`w-full px-4 py-3 text-sm border rounded-xl outline-none bg-slate-50 dark:bg-slate-800 dark:text-white transition-all ${formik.touched.rePassword && formik.errors.rePassword ? 'border-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-emerald-500'}`}
            />
