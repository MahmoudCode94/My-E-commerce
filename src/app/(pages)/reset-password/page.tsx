  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6 bg-slate-50 dark:bg-slate-950">
      <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] shadow-xl p-10 border border-slate-100 dark:border-slate-800">
        ...
        <h1 className="mb-2 text-2xl font-black text-center text-slate-900 dark:text-slate-50">
          Set New Password
        </h1>
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-5">
          <div>
            ...
            {formik.touched.email && formik.errors.email && (
              <p className="mt-1.5 ml-2 text-xs font-bold text-red-500">
                {formik.errors.email}
              </p>
            )}
          </div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-4 top-4 text-slate-400 hover:text-emerald-500"
            >
