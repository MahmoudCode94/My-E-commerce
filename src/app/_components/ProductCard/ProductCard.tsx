...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    <Card className="relative flex flex-col justify-between group overflow-hidden transition-all duration-300 hover:shadow-2xl border-transparent hover:border-slate-200 min-h-[480px] bg-white">
      <button className="absolute top-3 right-3 z-10 p-2 bg-white/70 backdrop-blur-md rounded-full shadow-sm hover:bg-white transition-all group/heart scale-90 hover:scale-105">
      ...
      <CardFooter className="p-3 pt-1">
        <button className="w-full bg-slate-950 text-white py-2.5 rounded-lg transition-all duration-300 hover:bg-emerald-600 active:scale-95 shadow-sm font-semibold text-xs uppercase">
          Add to Cart
        </button>
      </CardFooter>
    </Card>
